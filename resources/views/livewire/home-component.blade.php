		...
		<div class="navbar-wrapper  ">
			<div class="navbar-content scroll-div " >
				...
				<ul class="nav pcoded-inner-navbar ">
					...
					<li class="nav-item">
					    <a href="index.html" class="nav-link "><span class="pcoded-micon"><i class="feather icon-home"></i></span><span class="pcoded-mtext">Inventory</span></a>
					</li>
		...
		<!-- [ Main Content ] start -->
			...
			<div class="card">
				<div class="card-header">
					<h5 class="align:center">INVENTORY ITEM BATAMMAS SDA CHURCH</h5>
				</div>

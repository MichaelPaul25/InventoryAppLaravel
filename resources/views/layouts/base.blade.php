        ...
        <div class="navbar-wrapper  ">
            <div class="navbar-content scroll-div ">
                ...
                <ul class="nav pcoded-inner-navbar ">
                    ...
                    <li class="nav-item {{ $curRouteName == "dashboard" ? "active" : "" }}">
                        <a href="{{ route('dashboard') }}" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-home"></i></span><span class="pcoded-mtext">Dashboard</span></a>
                    </li>
                    <li class="nav-item {{ $curRouteName == "inventory" ? "active" : "" }}">
                        <a href="{{ route('inventory') }}" class="nav-link "><span class="pcoded-micon"><i
                                    class="feather icon-home"></i></span><span class="pcoded-mtext">Inventory</span></a>
                    </li>
                ...
                <div class="card text-center">
                    <div class="card-block">
                        ...
                        <h6 class="mt-3">Ask us</h6>
                        <p>Please contact us on our email for need any support</p>
                        <a target="_blank" class="btn btn-primary btn-sm text-white m-0">ASK US</a>
                    </div>
                </div>
    ...
    <header class="navbar pcoded-header navbar-expand-lg navbar-light header-dark">
        <div class="m-header">
            ...
            <a href="#!" class="b-brand">
                <img src="{{ asset('assets/images/logoGMAHK.png') }}" alt="" class="logo">
